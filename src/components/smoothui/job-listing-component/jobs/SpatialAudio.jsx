...
import spatialAudioIcon from '../resources/spatialAudio/spatial-audio-icon.webp';
import spatialImg1 from '../resources/spatialAudio/Yolo1.png';
...
const SpatialAudioJob = {
  company: 'Spatial Audio',
  title: 'Developing Spatial Audio Solution for interior cabins',
  logo: <img src={spatialAudioIcon} alt="Spatial Audio" className="w-10 h-10" />,
  job_description:
