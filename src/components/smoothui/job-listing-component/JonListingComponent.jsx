...
export const Supabase = (props) => (
  <svg fill="none" height="1em" viewBox="0 0 109 113" width="1em" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <defs>
      <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear" x1={53.9738} x2={94.1635} y1={54.974} y2={71.8295}>
        <stop stopColor="#249361" />
        <stop offset={1} stopColor="#3ECF8E" />
      </linearGradient>
      <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear" x1={36.1558} x2={54.4844} y1={30.578} y2={65.0806}>
        <stop />
...
export default function JobListingComponent({ jobs, className, onJobClick }) {
              ...
              transition={
                shouldReduceMotion
                  ...
                  : {
                      ...
                      duration: 0.25,
                      bounce: 0.1,
                      layout: { duration: 0.25, ease: [0.645, 0.045, 0.355, 1] },
                    }
              }
            >
              <div className="relative flex w-full items-center gap-4">
                <SmoothMotion.div
                  ...
                  style={{ willChange: shouldReduceMotion ? "auto" : "transform", flexShrink: 0 }}
                >
                  {activeItem.logo}
                </SmoothMotion.div>
        ...
        <div className="relative flex w-full flex-col items-center gap-4 px-2">
          {jobs.map((role) => (
            <SmoothMotion.div
              ...
              style={{ borderRadius: 8, willChange: shouldReduceMotion ? "auto" : "transform" }}
              transition={
                shouldReduceMotion
                  ? { duration: 0 }
                  : {
            ...
            >
              <SmoothMotion.div layoutId={shouldReduceMotion ? undefined : `workItemLogo-${role.company}`} style={{ willChange: shouldReduceMotion ? "auto" : "transform", flexShrink: 0 }}>
                {role.logo}
              </SmoothMotion.div>
              ...
              <div style={{ position: "absolute", top: "100%", opacity: 0, pointerEvents: "none" }}>{role.job_description}</div>
            </SmoothMotion.div>
          ))}
        </div>
      </div>
