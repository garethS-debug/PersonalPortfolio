const filesData = [
  {
    name: 'React-based UX Control System',
    techs: ['React', 'JavaScript', 'Node.js'],
  },
  {
    name: 'Real-time Instrument Cluster and Centre Display Demos',
    techs: ['Unity', 'C#', 'Blender'],
  },
  {
    name: 'Real-time 3D Environment with Computer Vision Audio Soundscape',
    techs: ['Unity', 'C#', 'Python', 'Signal Processing'],
  },
  {
    name: 'Multi-display UI Streaming / Networking Codebase',
  ...
  {
    name: 'Networked AI / Character Controller / Puzzles / Save System',
    techs: ['Unity', 'C#', 'Photon PUN 2'],
  },
  {
    name: 'Optimised Game Environment Assets',
    techs: ['Unity'],
  },
  {
    name: 'Freelance 3D Character Art Project',
    techs: ['Blender'],
  },
  {
    name: 'Kapia Alpha Testing',
    techs: ['QA Testing'],
  },
  {
    name: 'You Suck at Parking Alpha Testing',
    techs: ['QA Testing'],
  },
];
